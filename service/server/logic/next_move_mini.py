...
class MiniNextMoveHandler:
    ...
    def handle(self) -> MiniNextMoveResponse:
    ...
    def _make_spymaster_move(self) -> MiniNextMoveResponse:
    ...
    def _make_operative_move(self) -> MiniNextMoveResponse:
